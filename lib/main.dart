  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: KeyboardListener(
        ...
        autofocus: true,
        onKeyEvent: (event) {
          if (event is KeyUpEvent) {if (event.logicalKey == LogicalKeyboardKey.altLeft || event.logicalKey == LogicalKeyboardKey.altRight) {setState(() {lineMode = false;});
            }
            ...
            IgnorePointer(
              ...
              child: GestureDetector(
                ...
                onPanEnd: (details) {
                  if (lineMode) {
                    selectedIndex2 =
                        _selectIndex(details.localPosition);
                    ...
                    if (selectedIndex != -1 && selectedIndex2 != -1 && selectedIndex == selectedIndex2) {lineIndices.removeWhere((element) => element[0] == selectedIndex && element[1] == selectedIndex2);
                ...
                onPanUpdate: (details) {
                  ...
                  if (selectedLineIndex != -1) {
                    ...
                    if (length != 0) {
                      ...
                      linePerpendicularParts[selectedLineIndex] += details.delta.dx * perpDx + details.delta.dy * perpDy;
                      setState(() {});
                    }
                  }
                },
